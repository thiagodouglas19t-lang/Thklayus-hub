...
export const trilhas = [
  { nome: "Formação em Tecnologia", desc: "IA, websites, sistemas, API, lógica e criação de soluções digitais.", cursos: ["IA na Prática", "Qualificação Técnica em Desenvolvedor de Websites", "Qualificação Técnica em Desenvolvedor de Sistemas"], icon: "💻" },
