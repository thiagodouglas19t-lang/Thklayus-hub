...
export default function LobbyCharacter({ avatarEmoji, playerName, size = "normal" }: Props) {
  ...
  return (
    <div className={`relative mx-auto ${scale}`} aria-label={`${playerName} character`}>
      {aura.id !== "none" && <div className="absolute left-1/2 top-[55%] h-[92%] w-[130%] -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl" style={{ background: aura.color || "rgba(168,85,247,.35)" }} />}
