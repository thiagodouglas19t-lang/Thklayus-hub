          ...
          <div className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-white via-zinc-100 to-zinc-300 p-6 text-black md:p-10">
            ...
            <div className="relative mx-auto max-w-4xl text-center">
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                ...
                <div className="rounded-3xl bg-black p-4 text-white"><p className="text-xs text-zinc-400">Acesso</p><p className="font-black">Liberado</p></div>
              </div>
              ...
              <button key={course.id} onClick={() => abrirCurso(course)} className={`group overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-950 text-left transition hover:-translate-y-1 hover:border-white/30 ${!acesso ? "opacity-70" : ""}`}>
                ...
                <div className="space-y-4 p-5">
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="rounded-full border border-white/10 px-3 py-1 text-xs font-black text-zinc-300">{lessons} aulas</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-3 border-t border-white/10 pt-4">
                    ...
                    <span className="text-xs font-bold text-zinc-500">{acesso ? "Acesso liberado" : "Aguardando compra"}</span>
                  </div>
                </div>
              </button>
            );
