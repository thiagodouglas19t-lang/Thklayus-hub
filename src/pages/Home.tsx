...
export default function Home({ setPage }: HomeProps) {
  ...
  return (
    <div className="space-y-5 pb-4">
      ...
      <section className="min-w-0 rounded-[2.2rem] border border-white/10 bg-white/[0.035] p-6">
        <div className="grid min-w-0 gap-4 md:grid-cols-[0.8fr_1.2fr] md:items-center">
          <div className="min-w-0">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-violet-300">Como funciona</p>
            <h2 className="mt-3 text-3xl font-black tracking-[-0.06em] text-white">Você não precisa começar do zero.</h2>
      ...
      <section className="grid min-w-0 gap-4 lg:grid-cols-2">
        <article className="min-w-0 rounded-[2.2rem] border border-white/10 bg-white/[0.035] p-6">
        ...
        <article className="min-w-0 rounded-[2.2rem] border border-violet-300/15 bg-[radial-gradient(circle_at_top_right,rgba(124,58,237,0.2),transparent_38%),rgba(255,255,255,0.035)] p-6">
